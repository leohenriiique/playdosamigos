...
import {
  ...
  Swords, Crown, Coffee, Star, X as XIcon, ArrowLeft, Loader2, AlertCircle, Calendar
} from "lucide-react";
import {
  listTournaments, createTournament, loadTournament,
  saveTournamentData, deleteTournament,
  ...
  return (
    <div>
        ...
        <Section icon={Shuffle} title="Como formar as duplas do mata-mata?" subtitle="Os classificados jogaram individualmente na fase de grupos — agora escolha como parear em duplas para a fase eliminatória.">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-3">
            <div
              ...
              className={`bt-option-card ${playoffPairMode === "seed" ? "bt-option-card-active" : "bt-option-card-inactive"}`}
            >
            ...
            <div
              ...
              className={`bt-option-card ${playoffPairMode === "draw" ? "bt-option-card-active" : "bt-option-card-inactive"}`}
            >
            ...
            <div
              ...
              className={`bt-option-card ${playoffPairMode === "manual" ? "bt-option-card-active" : "bt-option-card-inactive"}`}
            >
      ...
      <Section
        ...
        right={
          <button className="bt-btn bt-btn-coral" onClick={generate} disabled={entries.length < 2 || manualIncomplete}>
...
/* ---------------------------------------------------------------
   APP
----------------------------------------------------------------*/
function TournamentWorkspace({ tournamentId, tournamentName, onExit }) {
  ...
  }, [tournamentId, athletes, groups, manualPairs, config, classConfig, playoff, playoffPairMode, playoffManualPairs, playoffDrawOrder, loaded]);
      ...
      <div className="bt-bg-ocean-deep px-5 md:px-8 pt-6 pb-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-2xl md:text-3xl font-bold bt-text-white">{tournamentName || "Play dos Amigos"}</h1>
...
----------------------------------------------------------------*/
function TournamentsHome({ tournaments, loading, error, onCreate, onOpen, onDelete, creating }) {
