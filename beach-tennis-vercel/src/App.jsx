...
import {
  ...
  saveTournamentData, deleteTournament, fetchAllTournamentsFull,
} from "./lib/tournaments";
import { findOrCreateAthlete, createAthletesBulk } from "./lib/athletes";
...
function AthletesTab({ athletes, setAthletes, groupsExist }) {
  ...
  const addAthlete = async () => {
    ...
    setErrMsg("");
    try {
      const global = await findOrCreateAthlete({ name: trimmed, phone, instagram });
    ...
    <div>
      <Section icon={Users} title="Cadastro de atletas" subtitle="Adicione os jogadores que vão participar do torneio.">
        ...
        <p className="text-xs text-stone-400 -mt-2 mb-3">
          Celular ou Instagram ajudam o app a reconhecer o mesmo atleta em outros campeonatos, pro ranking geral. Sem nenhum dos dois, o atleta ainda entra no torneio normalmente, só não é possível uni-lo automaticamente a cadastros de outros campeonatos.
        </p>
